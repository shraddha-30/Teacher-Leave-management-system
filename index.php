<?php
    ...
    if(isset($_POST['signin']))
    {
        ...
        $sql ="SELECT EmailId,Password,Status,id FROM tblteacher WHERE EmailId=:uname and Password=:password";
            ...
            if($status==0)
        {
            ...
            echo "<script type='text/javascript'> document.location = 'teacher/leave.php'; </script>";
        }
            }   else  {
