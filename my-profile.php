<?php
    ...
    $sql="update tblteacher set FirstName=:fname,LastName=:lname,Gender=:gender,Dob=:dob,Department=:department,Address=:address,City=:city,Country=:country,Phonenumber=:mobileno where EmailId=:eid";
    ...
    <div class="page-container">
        ...
        <div class="sidebar-menu">
            <div class="sidebar-header">
                <div class="logo3 (2)">
                    <a href="leave.php"><img src="../assets/images/icon/logo3 (2).png" alt="logo3 (2)"></a>
                </div>
            </div>
            <div class="main-menu">
                            ...
                            <?php if($error){?><div class="alert alert-danger alert-dismissible fade show"><strong>Info: </strong><?php echo htmlentities($error); ?>
                                ...
                                <form name="addemp" method="POST">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <?php 
                                            $eid=$_SESSION['tealogin'];
                                            $sql = "SELECT * from  tblteacher where EmailId=:eid";
                                            $query = $dbh -> prepare($sql);
                                            $query -> bindParam(':eid',$eid, PDO::PARAM_STR);
                                            $query->execute();
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input class="form-control" name="tcode" type="text" autocomplete="off" readonly required value="<?php echo htmlentities($result->tid);?>" id="example-text-input">
                                        </div>
