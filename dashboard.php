                        ...
                        <div class="col-md-4">
                            <div class="single-report mb-xs-30">
                                <div class="s-report-inner pr--20 pt--30 mb-3">
                                    ...
                                    <div class="s-report-title d-flex justify-content-between">
                                        <h4 class="header-title mb-0">Registered Teacher</h4>
                    ...
                    <div class="col-12">
                        <div class="card">
							...
							<div class="d-sm-flex justify-content-between align-items-center">
                                    <!-- <h4 class="header-title">teacher Leave History</h4> -->
                                    ...
                                    <select class="custome-select border-0 pr-3">
                                        ...
                                        <div class="single-table">
                                            <div class="table-responsive">
                                                ...
                                                <?php 
                                                    ...
                                                    $sql = "SELECT tblleaves.id as lid,tblteacher.FirstName,tblteacher.LastName,tblteacher.tid,tblteacher.id,tblleaves.LeaveType,tblleaves.PostingDate,tblleaves.Status from tblleaves join tblteacher on tblleaves.tid=tblteacher.id order by lid desc limit 7";
                                        ...
                                        <tr>
                                            ...
                                            <td><a href="update-teacher.php?tid=<?php echo htmlentities($result->id);?>" target="_blank"><?php echo htmlentities($result->FirstName." ".$result->LastName);?></a></td>
