<?php
    ...
    $sql="INSERT INTO tblteacher(tid,FirstName,LastName,EmailId,Password,Gender,Dob,Department,Address,City,Country,Phonenumber,Status) VALUES(:tid,:fname,:lname,:email,:password,:gender,:dob,:department,:address,:city,:country,:mobileno,:status)";
...
<head>
    ...
    <script type="text/javascript">
        function valid(){
            if(document.addteac.password.value!= document.addteac.confirmpassword.value) {
            alert("New Password and Confirm Password Field do not match  !!");
            document.addteac.confirmpassword.focus();
            return false;
                } return true;
        }
    </script>
    ...
    <script>
        function checkAvailabilitytid() {
            $("#loaderIcon").show();
            jQuery.ajax({
            url: "check_availability.php",
            data:'tcode='+$("#tcode").val(),
            type: "POST",
            success:function(data){
            $("#tid-availability").html(data);
            $("#loaderIcon").hide();
            },
            error:function (){}
            });
                                ...
                                <form name="addteac" method="POST">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input class="form-control" name="tcode" type="text" autocomplete="off" required id="tcode" onBlur="checkAvailabilitytid()">
                                        </div>
