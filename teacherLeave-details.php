                                ...
                                <div class="single-table">
                                    <div class="table-responsive">
                                        <table class="table table-bordered table-hover text-center">
                                            ...
                                            $sql = "SELECT tblleaves.id as lid,tblteacher.FirstName,tblteacher.LastName,tblteacher.tid,tblteacher.id,tblteacher.Gender,tblteacher.Phonenumber,tblteacher.EmailId,tblleaves.LeaveType,tblleaves.ToDate,tblleaves.FromDate,tblleaves.Description,tblleaves.PostingDate,tblleaves.Status,tblleaves.AdminRemark,tblleaves.AdminRemarkDate from tblleaves join tblteacher on tblleaves.tid=tblteacher.id where tblleaves.id=:lid";
                                            $query = $dbh -> prepare($sql);
                                            ...
                                            {         
                                              ...
                                              <td colspan="1"><?php echo htmlentities($result->tid);?></td>
                                            <td> <b>teacher Name:</b></td>
                                              <td colspan="1"><a href="update-teacher.php?tid=<?php echo htmlentities($result->id);?>" target="_blank">
