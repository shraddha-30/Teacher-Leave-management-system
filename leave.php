<?php
    ...
    header('location:../index.php');
        ...
        $sql="INSERT INTO tblleaves(LeaveType,ToDate,FromDate,Description,Status,IsRead,tid) VALUES(:leavetype,:fromdate,:todate,:description,:status,:isread,:tid)";
    ...
    <div class="page-container">
        ...
        <div class="sidebar-menu">
            <div class="sidebar-header">
                <div class="">
                    <a href="leave.php"><img src="" alt=""></a>
                </div>
            </div>
            <div class="main-menu">
