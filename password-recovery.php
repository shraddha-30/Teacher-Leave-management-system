            ...
            <div class="login-box ptb--100">
                ...
                <form method="POST" name="signin">
                    <div class="login-form-head">
                        ...
                        <p>Please provide your teacher details for recovery.</p>
                    </div>
                    <div class="login-form-body">
                        ...
                        <div class="form-gp">
                            ...
                            <input type="text" id="exampleInputPassword1" name="tid" autocomplete="off">
                ...
                $tid=$_POST['tid'];
                $email=$_POST['emailid'];
                $sql ="SELECT id FROM tblteacher WHERE EmailId=:email and tid=:tid";
